...
enum class ActivityCategory(val title: String, val color: Int = "#FFFFFFFF".toColorInt(), val icon: Int = R.drawable.ic_baseline_add_24) {
    ...
    WRITING("Writing", icon = R.drawable.ic_activity_writing_48, color = "#FF9c27b0".toColorInt() ),
    LISTENING("Listening", icon = R.drawable.ic_activity_listening_48, color = "#FF6a1b9a".toColorInt() ),
    SPEAKING("Speaking", icon = R.drawable.ic_activity_speaking_48, color = "#FFE69F00".toColorInt() ),
    LEARNING("Studying", icon = R.drawable.ic_activity_learning_48, color = "#FF2196f3".toColorInt() ),
